    ...
    return <div>
        ...
        { showSidebar && <div className="sidebar bg-light p-3 gradient-background" style={ {
            ...
            <div className="card mb-3">
                ...
                <div className="card-body">
                    { waypoints && waypoints.length > 0 ? <DragDropContext onDragEnd={ onDragEnd }>
